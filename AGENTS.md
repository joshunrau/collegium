...
app/src/
  ...
  utils/
  web/            the browser: turn-scoped Camoufox sessions, ref-stamped snapshots, page-to-markdown; and the plain HTTP fetch (a PDF read by its text layer) and provider-backed search beside it
