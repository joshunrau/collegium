...
export const CONVERSATIONS_TOOLSET = implementToolset(CONVERSATIONS_TOOLSET_DEF, {
  ...
  tools: {
    ...
    search: {
      description:
        'Search past posts by text, across the channels you are in whose readers include everyone who can read ' +
        'this channel. Returns the newest matches first, each with its post id, channel, author and time. ' +
