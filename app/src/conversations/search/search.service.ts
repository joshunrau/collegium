 ...
 * channel's own episode boundary, never a forgotten post, and posts alone — the trace and stored
 * reasoning are not posts and never leave the turn that made them.
 */
@Injectable()
