...
/**
 * Provisioning happens at install time (`scripts/postinstall.ts`). This check is what keeps a
 * missing binary from becoming a multi-minute download inside a tool call: camoufox-js downloads
