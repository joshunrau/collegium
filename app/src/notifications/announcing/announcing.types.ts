...
export type Announcement = {
  /** the system bot, or the DM's agent speaking as deterministic code (§3.2) */
  readonly authorKind: 'agent' | 'system';
  readonly authorUsername: string;
  readonly createdAt: Date;
  readonly edit: (text: string) => Promise<Result<void, ChatFailure>>;
