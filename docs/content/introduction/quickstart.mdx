...
The defaults start a Mattermost beside the app. To use one you already run, follow [Use an Existing Mattermost](/docs/guides/use-an-existing-mattermost) instead.
...
To see every tool call from a turn with its full arguments and results, run `/collegium trace` in the channel.
...
Next: [Next Steps](/docs/introduction/next-steps).
