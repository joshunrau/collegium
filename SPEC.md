...
10. **Open work** — the units this agent created or was assigned in this channel and has not closed (§3.15), oldest first, one line each with where the other party stands, or a line saying none is open, so that absence reads as a fact and not as an omission. Read on demand for the rest, as a memory's body is.
