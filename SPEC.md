...
- Memory is per-agent and never shared between agents. A reference to another agent's entry resolves to nothing, and the refusal says that memories are private.
